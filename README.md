# react-native-collapsible-container

_Animated collapsible view component for React Native based on [react-native-collapsible]_
...
```bash
$ npm install react-native-collapsible-container
